...
const names = process.argv[4] === "markers" ? Array.from({ length: 12 }, (_, i) => `m${i}`) : process.argv[4] === "sweep" ? [4, 5].flatMap(z => Array.from({ length: 24 }, (_, i) => `s${z}_${i}`)) : ["z0","z0r","z1","z2","z3","z3u","z4","z5","z0b"];
