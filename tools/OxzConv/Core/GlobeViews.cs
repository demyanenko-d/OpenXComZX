...
namespace OxzConv
{
	static class GlobeViews
	{
		...
		// Предел наклона (globe.md §12.11): полюс должен попадать в окно так же, как на зуме 0 при 27° —
		// на R·cos C <= 90·cos 27° (~80 точек) от центра; прямо над полюсом вид не нужен. Предел — первый
		// шаг сетки, где это выполнено: z0 27°, z1 49.5°, z2 66°, z3 74.25°, z4 81°, z5 84°. Шаг наклона —
		// родной, 0.6 от шага поворота, чтобы наклон не огрубился.
		const double Tilt0 = 27;
