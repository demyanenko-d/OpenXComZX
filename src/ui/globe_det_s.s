;; Банк 26: точки и отрезки деталей глобуса (globe_det.c) в задний буфер — строки экрана 280..479,
;; окно 256 x 200. Параметры — в переменных globe_det.c (хвост страницы банка): DL_X0, DL_Y0, DL_X1,
;; DL_Y1 (int16), DL_C. Экран 256c: строка — 512 байт, страница — 32 строки (src/map.h): адрес в Win3 =
